...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  document.getElementById('search_person').addEventListener('keyup', function (event) {
    searchPerson();
  });
  ...
  const validateForm = () => {
    ...
    const fields = document.forms.myForm;
    ...
    // else assign data to variables and call addPerson function with data as arguments
      ...
      let firstname = fields.firstname.value.trim().toLowerCase();
      firstname = firstname[0].toUpperCase() + firstname.slice(1, firstname.length);
      // removing extra blank space / uppercase
      let lastname = fields.lastname.value.trim().toUpperCase();
      // removing extra blank space / uppercase
      let address = fields.address.value.trim().toUpperCase();
      // removing extra blank space
      let zip_address = fields.zip_address.value.trim();
      // removing extra blank space / uppercase
      let city_address = fields.city_address.value.trim().toUpperCase();
      // removing extra blank space
